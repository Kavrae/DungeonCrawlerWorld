...
public sealed class Notification(string text, NotificationCategory category, string? title = null, AchievementNotificationDetails? achievement = null)
{
    ...
    /// <summary>Non-null only for NotificationCategory.Achievement -- see NotificationCenter.ShowActive, which appends these fields after Text.</summary>
    public AchievementNotificationDetails? Achievement { get; } = achievement;
}