    ...
    MapWindow mapWindow)
{
    ...
    public bool IsOutsideClick(Point clickPosition)
    {
        ...
        return GetSecondaryInventoryWindowRectangle?.Invoke().Contains(clickPosition) != true;
    }
    ...
    public void Open(int entityId, Guid stackInstanceId)
    {
        ...
        {
            existing.Configure(definition, playerWindow.ContentSize.X);
        ...
        window.Configure(definition, playerWindow.ContentSize.X);
