...
/// explicitly owns no systems of its own, and folding this into MovementModule/AbilitiesModule/
...
public sealed class NpcBehaviorModule : IGameModule
{
    ...
    public void RegisterSystems(SystemManager systemManager, ComponentManager componentManager)
    {
        if (!componentManager.IsRegistered<HealthComponent>() ||
            ...
            !componentManager.IsRegistered<AbilityInstanceComponent>() ||
            !componentManager.IsRegistered<PendingAbilityActivationComponent>() ||
