...
/// <summary>
/// One bound hotkey slot referencing an inventory item stack rather than an ability -- sibling to
/// ActionHotkeyBindingComponent (Game.Modules.Abilities.Components), see IHotkeySlotBinding
/// (Game.Modules.Abilities.HotkeySlot.cs) for what the two share and why this isn't a base-class
