...
public sealed class HotbarContentTests
{
    ...
    public void Size_AccountsForTenSlotsAcrossThreeVisualGroups()
    {
        ...
        // intra-group gaps, plus 2 gaps between the 3 groups themselves. SlotGap (4) and
        // GroupGap (16) are HotbarContent's own private constants, duplicated here rather than
