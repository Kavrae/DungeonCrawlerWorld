...
/// <summary>
/// The 2d footprint on the map tiles that an ability's targeting resolves to.
/// </summary>
/// <remarks
...
public enum TargetShape : byte
{
    ...
    /// <summary> The perimeter ring of tiles surrounding the caster's own footprint, plus the caster's own footprint tiles.
    /// </summary>
    /// <remarks>
    /// Same ring as Adjacent (Chebyshev distance &lt;= 1 from any footprint tile), but does not
    /// exclude the caster's own footprint.
    /// 
    /// TargetingSpec.AreaSize and Range are not valid for this shape.
    /// </remarks>
    AdjacentWithSelf,
    ...
    /// <summary> The caster's own tiles </summary>
    /// <remarks>
